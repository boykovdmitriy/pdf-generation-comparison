...
import { pdfLibGenerator } from './pdfLibGenerator';
import {
  Button,
  LoadingPlaceholder,
  PdfViewer,
...
const PdfLibDocPreview = ({ data }: Props) => {
  const { onDownload } = useDownloadPdf({ data, engine: 'pdf-lib' });
...
export default PdfLibDocPreview;
